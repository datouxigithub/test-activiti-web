			...
			<c:forEach items="${list }" var="model">
				<tr>
					...
					<td>
						...
						<a href="${ctx}/workflow/deploy/${model.id}">部署</a>
						导出(<a href="${ctx}/workflow/export/${model.id}/bpmn" target="_blank">BPMN</a>
						|&nbsp;<a href="${ctx}/workflow/export/${model.id}/json" target="_blank">JSON</a>
						|&nbsp;<a href="javascript:;" onclick='showSvgTip()'>SVG</a>)
                        <a href="${ctx}/workflow/delete/${model.id}">删除</a>
					</td>
				</tr>
			</c:forEach>
		</tbody>
